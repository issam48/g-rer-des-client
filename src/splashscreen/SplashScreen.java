...
public class SplashScreen extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/splashscreen/microchip_3672413.png"))); // NOI18N
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    doTask("Connect To Database ...", 10);
                     try {
            File songFile = new File("src\\son\\scard (1).wav"); // Replace with the actual path to your song file
            ...
            clip.stop();
                    ...
                    doTask("  IIPE ", 100);
                    doTask("web service project", 100);
